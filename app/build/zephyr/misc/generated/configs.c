...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLINK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLINK_INIT_PRIORITY, 50);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_NCS_EXAMPLE_APPLICATION_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_WEAVER_BIKE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_WEAVER_BIKE_NRF52833, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPU6050_ACCEL_FS, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPU6050_GYRO_FS, 250);
